...
cfg = {
	...
	deformationMultiplier = 0.1,					-- How much should the vehicle visually deform from a collision. Range 0.0 to 10.0 Where 0.0 is no deformation and 10.0 is 10x deformation. -1 = Don't touch
	...
	damageFactorPetrolTank = 0.0,				-- Sane values are 1 to 200. Higher values means more damage to vehicle. A good starting point is 64
